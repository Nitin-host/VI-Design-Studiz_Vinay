                ...
                {isNavbarVisible && (
                    <Navbar expand="lg" fixed="top" style={{ backgroundColor: 'white' }}>
                        <Navbar.Brand href="/" className='d-flex justify-content-center align-items-center'>
                            <Image src={logo} width={100} height={100} alt='logo' className="navbar-logo" />
                            <h3 className='mt-4 ms-3 brand-title'>Design Studio<span className='brand-color'>z</span></h3>
                        </Navbar.Brand>
